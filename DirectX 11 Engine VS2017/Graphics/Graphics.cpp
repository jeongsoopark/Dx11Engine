...
void Graphics::RenderFrame()
{
	...
	ImGui::DragFloat("Alpha", &alpha, 0.f, 0.0f, 1.0f);
	ImGui::End();
...
bool Graphics::InitializeDirectX(HWND hwnd)
{
	try
	{
		...
		COM_ERROR_IF_FAILED(hr, "Filed to create render target view");
...
bool Graphics::InitializeScene()
{
	...
	{
		//Load Texture
		HRESULT	hr = DirectX::CreateWICTextureFromFile(this->device.Get(), L"Data\\Textures\\grass.jpg", nullptr, myGrassTexture.GetAddressOf());
		COM_ERROR_IF_FAILED(hr, "Failed to create wic texture from file");

		//Load Texture
		hr = DirectX::CreateWICTextureFromFile(this->device.Get(), L"Data\\Textures\\nvidia.png", nullptr, myNvidiaTexture.GetAddressOf());
		COM_ERROR_IF_FAILED(hr, "Failed to create wic texture from file");
